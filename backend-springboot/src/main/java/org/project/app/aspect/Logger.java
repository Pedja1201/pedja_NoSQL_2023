package org.project.app.aspect;
...
public class Logger {
    ...
    @Around("execution(* org.project.app.controller.UserController.*(Long))")
    ...
    @After("execution(* org.project.app.controller.UserController.*(Long)) && args(id,..)")
